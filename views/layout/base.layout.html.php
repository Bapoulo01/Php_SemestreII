...
<body>
        <nav
            class="fixed top-0 z-50 w-full bg-indigo-600 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <aside id="logo-sidebar"
            class="fixed top-0 left-0 z-40 w-48 h-screen pt-20 transition-transform -translate-x-full bg-indigo-600 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
            aria-label="Sidebar">
