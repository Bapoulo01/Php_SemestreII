...
<div class="w-2/5 h-5/6 mx-auto">
    <div class="w-full h-5/6 flex-col align-center justify-center rounded shadow">
        ...
        <?php if (isset($errors['connect'])) { ?>
            <div class=" w-96 mx-auto p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                ...
                <div class="mb-5 w-96 mx-auto flex-col">
                    ...
                    <div class="w-full flex align-center justify-center mt-5">
                            <button type="submit" name="action" value="login"
                                class=" w-64 mb-5 text-white bg-sky-900  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Se Connecter
                            </button>
                    </div>
                </div>
